...
public class CrawlerPanelMainClass extends JPanel implements TreeSelectionListener, ActionListener, KeyListener {
	/**
	 * 
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				CrawlerPanelMainClass l = new CrawlerPanelMainClass();
	...
	private void createTreeWithTreeNode(DefaultMutableTreeNode top) {
		 ...
		 * 
		 * // add some styles to the html StyleSheet styleSheet = kit.getStyleSheet();
	...
	private void searchXPath() {
		...
		/*
		 * XPath xpath = XPathFactory.newInstance().newXPath(); String expression =
		 * xPathSearchField.getText(); W3CDom w3cDom = new W3CDom();
		 * org.w3c.dom.Document w3cDoc = w3cDom.fromJsoup(doc);
		 * 
		 * try { String xml = "<foo><bar/><bar/><bar/></foo>"; InputSource inputSource;
		 ...
		 * XPathConstants.NODESET); System.out.println(nodes.getLength()); } catch
